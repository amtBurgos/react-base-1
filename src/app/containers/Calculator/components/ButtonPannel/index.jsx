        ...
        <div className={styles.Column}>
          <div className={styles.Row}>
            <Button
              type="number"
              value="C"
              onClick={() => this.actions.inputOperation(ActionTypes.CLEAN)}
            />
            <Button
              type="number"
              value="+/-"
              onClick={() => this.actions.inputOperation(ActionTypes.CHANGE_SIGN)}
            />
            <Button
              type="number"
              value="%"
              onClick={() => this.actions.inputOperation(ActionTypes.PERCENT)}
            />
            <Button
              type="operator"
              value="÷"
              onClick={() => this.actions.inputOperator(ActionTypes.DIVIDE)}
            />
          </div>
          <div className={styles.Row}>
            ...
            <Button
              type="operator"
              value="x"
              onClick={() => this.actions.inputOperator(ActionTypes.MULTIPLY)}
            />
          </div>
          <div className={styles.Row}>
            ...
            <Button
              type="operator"
              value="-"
              onClick={() => this.actions.inputOperator(ActionTypes.SUBSTRACT)}
            />
          </div>
          <div className={styles.Row}>
            ...
            <Button
              type="operator"
              value="+"
              onClick={() => this.actions.inputOperator(ActionTypes.SUM)}
            />
          </div>
          <div className={styles.Row}>
